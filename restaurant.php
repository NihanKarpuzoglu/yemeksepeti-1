...
<head>
   ...
   <?php
        ...
        $res_id = $_GET["res_id"];
        $restaurant_query = mysqli_query($result,"select * from restaurants where $res_id = res_id");
        $restaurant_menu_query = mysqli_query($result,"select * from menu where $res_id = res_id");
        $restaurant_comment_query = mysqli_query($result,"select * from feedbacks where $res_id = res_id");

        $sql = "INSERT INTO shopping_card (user_id) VALUES ('1')";

        if ($result->query($sql) === TRUE) {
            $last_sc_id = $result->insert_id;
        } 
                                                        ...
                                                        <div class="modal-dialog">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form method="post" action="">
                                                                    <input class="btn btn-success" type="submit" name="action" value="Sepete Ekle"/>
                                                                    <input type="hidden" name="add_to_basket1" value="<?php echo $_POST[$items['menu_id']];?>"/>
                                                                    <input type="hidden" name="add_to_basket2" value="<?php echo $_POST[$last_sc_id];?>"/>
                                                                </form> 
